...
export default function SuppliersPage() {
  ...
  const load = useCallback(() => {
    setLoading(true);
    api.get('/suppliers', { params: { search, contact_type: filterType || undefined, page, page_size: 50 } })
  ...
  return (
    <div>
      <PageHeader title="Suppliers / Contacts" actions={<button className="btn-primary text-sm" onClick={openNew}>+ Add Contact</button>} />
          ...
          <>
            <DataTable
              ...
              columns={[
                ...
                { header: 'Type', accessor: 'contact_type' },
                { header: 'Contact', accessor: 'contact_person', hideOnMobile: true },
                { header: 'Phone', accessor: 'phone', hideOnMobile: true },
                { header: 'GST', accessor: 'gst_no', hideOnMobile: true },
              ]}
            />
